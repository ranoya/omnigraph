play = function (p) {
  ...
  omnifilter = function (arr) {
    ...
    for (let i = 0; i < arr.length; i++) {
      code += `<div onclick="ifr();" style="width: 100%; aspect-ratio: 4/3; background-repeat: no-repeat; background-size: cover; background-position: center center; background-image: url(${arr[i].screenshots})"></div>`;
    }
